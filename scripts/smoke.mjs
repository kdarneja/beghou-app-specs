...
const ROUTES = ['/', '/stacked-windows', '/map-toolbars', '/alignment-manage-views', '/calendar', '/launch-planning', '/small-calendar', '/app-visualizations', '/edit-product-roles', '/goal-refinement'];
